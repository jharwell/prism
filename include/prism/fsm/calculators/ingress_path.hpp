...
#ifndef INCLUDE_PRISM_FSM_CALCULATORS_INGRESS_PATH_HPP_
#define INCLUDE_PRISM_FSM_CALCULATORS_INGRESS_PATH_HPP_
...
#endif /* INCLUDE_PRISM_FSM_CALCULATORS_INGRESS_PATH_HPP_ */
