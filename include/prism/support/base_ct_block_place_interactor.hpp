 ...
 * a gmt, if the conditions necessary for the event are met, updating the
...
class base_ct_block_place_interactor
 ...
 public:
  ...
  base_ct_block_place_interactor(pgmt::ct_manager* const ct_manager,
                                 arena_map_type* const arena_map,
                                 metrics_manager_type* const metrics_manager,
                                 argos::CFloorEntity* const floor)
      : ER_CLIENT_INIT("prism.support.base_ct_block_place_interactor"),
