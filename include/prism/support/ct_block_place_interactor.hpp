...
#ifndef INCLUDE_PRISM_SUPPORT_CT_BLOCK_PLACE_INTERACTOR_HPP_
#define INCLUDE_PRISM_SUPPORT_CT_BLOCK_PLACE_INTERACTOR_HPP_

/*******************************************************************************
 * Includes
 ******************************************************************************/
#include "prism/support/base_ct_block_place_interactor.hpp"
...
class ct_block_place_interactor
 ...
 public:
  ...
  ct_block_place_interactor(pgmt::ct_manager* const ct_manager,
  ...
  void robot_previsit_hook(TController& controller,
    ...
    controller.block_manip_recorder()->record(
        metrics::blocks::block_manip_events::ekSPCT_PLACE,
        penalty.penalty());
  }
...
#endif /* INCLUDE_PRISM_SUPPORT_CT_BLOCK_PLACE_INTERACTOR_HPP_ */
