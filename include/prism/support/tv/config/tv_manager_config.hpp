...
#ifndef INCLUDE_PRISM_SUPPORT_TV_CONFIG_TV_MANAGER_CONFIG_HPP_
#define INCLUDE_PRISM_SUPPORT_TV_CONFIG_TV_MANAGER_CONFIG_HPP_
...
#endif /* INCLUDE_PRISM_SUPPORT_TV_CONFIG_TV_MANAGER_CONFIG_HPP_ */
