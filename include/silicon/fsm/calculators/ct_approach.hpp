...
#ifndef INCLUDE_SILICON_FSM_CALCULATORS_CT_APPROACH_HPP_
#define INCLUDE_SILICON_FSM_CALCULATORS_CT_APPROACH_HPP_
...
class ct_approach : public rer::client<ct_approach> {
 public:
  ...
  ct_approach_vector operator()(const srepr::construction_lane* lane) const;
...
#endif /* INCLUDE_SILICON_FSM_CALCULATORS_CT_APPROACH_HPP_ */
