...
#ifndef INCLUDE_SILICON_STRUCTURE_REPR_VSHELL_HPP_
#define INCLUDE_SILICON_STRUCTURE_REPR_VSHELL_HPP_
 ...
 * \ingroup structure
 *
 * \brief Representation of the virtual 3D shell around a \ref structure3D. The
...
class vshell : public rer::client<vshell> {
 public:
   ...
   * units of # cells;
   */
  size_t sh_sized(void) const { return kWIDTH_CELLS; }
 ...
 public:
   ...
   * outer part of the virtual shell which surrounds the a \ref structure3D.
   */
  RCPPSW_WRAP_DECLDEF_AS(ranchor3D, m_outer, voriginr, const);

  /**
   * \brief Get the real arena coordinates of the origin (LL corner) of the
   * inner part of a the virtual shell which surrounds a \ref structure3D; this
   ...
   * outer part of the virtual shell which surrounds a \ref structure3D.
   */
...
#endif /* INCLUDE_SILICON_STRUCTURE_REPR_VSHELL_HPP_ */
