...
#ifndef INCLUDE_SILICON_SUPPORT_CT_COMPLETE_INTERACTOR_HPP_
#define INCLUDE_SILICON_SUPPORT_CT_COMPLETE_INTERACTOR_HPP_
...
class ct_complete_interactor
 ...
 public:
  explicit ct_complete_interactor(sstructure::ct_manager* const ct_manager)
      : ER_CLIENT_INIT("silicon.support.ct_complete_interactor"),
...
#endif /* INCLUDE_SILICON_SUPPORT_CT_COMPLETE_INTERACTOR_HPP_ */
