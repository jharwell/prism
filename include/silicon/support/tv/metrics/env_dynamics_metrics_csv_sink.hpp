...
#ifndef INCLUDE_SILICON_SUPPORT_TV_METRICS_ENV_DYNAMICS_METRICS_CSV_SINK_HPP_
#define INCLUDE_SILICON_SUPPORT_TV_METRICS_ENV_DYNAMICS_METRICS_CSV_SINK_HPP_
 ...
 *
 * \brief Sink for \ref env_dynamics_metrics and \ref env_dynamics_metrics_collector to
 * output metrics to .csv..
 */
class env_dynamics_metrics_csv_sink final : public rmetrics::csv_sink {
 public:
...
#endif /* INCLUDE_SILICON_SUPPORT_TV_METRICS_ENV_DYNAMICS_METRICS_CSV_SINK_HPP_ */
