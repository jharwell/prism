...
placement_intent::placement_intent(
    ...
    : ER_CLIENT_INIT("prism.fsm.calculator.placement_intent"),
      mc_sensing(sensing),
...
placement_intent::operator()(const prepr::construction_lane* lane) const {
   ...
   * of the gmt, so we want virtual CT coordinates.
   */
