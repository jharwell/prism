...
std::list<std::string> subtargets_metrics_collector::csv_header_cols(
  ...
  for (size_t i = 0; i < m_interval.size(); ++i) {
    cols.push_back("int_avg_subtarget" + std::to_string(i) + "placed_count");
    cols.push_back("int_avg_subtarget" + std::to_string(i) + "total_count");
  } /* for(i..) */
  for (size_t i = 0; i < m_cum.size(); ++i) {
    cols.push_back("cum_avg_subtarget" + std::to_string(i) + "placed_count");
    cols.push_back("cum_avg_subtarget" + std::to_string(i) + "total_count");
  } /* for(i..) */
